...
code "quicksort" ch = printObjectiveC $ T.toImp $ qsProg ch
code "fibonacci" ch = printObjectiveC $ T.toImp $ fibProg ch
code "factorial" ch = printObjectiveC $ T.toImp $ facProg ch
code "exponent" ch = printObjectiveC $ T.toImp $ expProg ch
code "gcdlcm" ch = printObjectiveC $ T.toImp $ glProg ch
code "palindrome" ch = printObjectiveC $ T.toImp $ palProg ch
code "maximum" ch = printObjectiveC $ T.toImp $ maxProg ch 
code "hello" ch = printObjectiveC $ T.toImp $ helloProg ch 
